...
.EXAMPLE
  .\generate-ue-project-files.ps1 -UProjectPath "C:\Users\Me\Documents\Unreal Projects\FabTest\FabTest.uproject"

.EXAMPLE
  .\generate-ue-project-files.ps1 -UProjectPath "D:\Games\MyGame\MyGame.uproject" -EngineRoot "C:\Program Files\Epic Games\UE_5.7"
#>
