...
2. **Extract** the archive. You should see a folder named `LevelSelectionSets` containing `LevelSelectionSets.uplugin`, a `Source` directory, and (for the editor icon) `Resources/Icon128.png`.
