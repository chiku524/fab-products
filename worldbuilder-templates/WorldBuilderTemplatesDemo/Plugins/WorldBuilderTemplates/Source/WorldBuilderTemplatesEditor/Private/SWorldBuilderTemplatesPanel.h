...
private:
	...
	FReply OnGenerateProceduralMap();
	FReply OnRandomizeSeedClicked();
	void OnProceduralKindChanged(TSharedPtr<FString> NewSelection, ESelectInfo::Type SelectInfo);
	...
	TArray<TSharedPtr<FString>> ProceduralKindOptions;
	TSharedPtr<FString> CurrentProceduralKindLabel;
	EWorldBuilderTemplateKind ProceduralKind = EWorldBuilderTemplateKind::Outdoor;
	int32 ProceduralSeed = 1;
	bool bOutdoorScatterTrees = false;
};
