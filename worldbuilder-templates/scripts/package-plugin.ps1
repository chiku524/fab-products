...
<#
.SYNOPSIS
  Runs Epic's RunUAT BuildPlugin for World Builder Templates (Windows editor plugin).
...
$PluginFile = Join-Path $ProductRoot "WorldBuilderTemplates\WorldBuilderTemplates.uplugin"
...
$PackageName = "WorldBuilderTemplates-UE$UeVersionLabel-Win64"
...
Write-Host "Done. Content under Content/ and Config/ is included when CanContainContent is true."
Write-Host "Smoke-test on a clean project before Fab upload (see docs/PACKAGING_FOR_FAB.md)."
